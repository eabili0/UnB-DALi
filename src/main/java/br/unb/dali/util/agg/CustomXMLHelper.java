...
public class CustomXMLHelper extends XMLHelper {
	...
	private Vector<Node> estack = new Vector<Node>(); 

	private Vector<Node> chld_stack = new Vector<Node>();
	...
	public boolean read_from_xml(InputStream xml) {
		this.esp = 0;
		try {
			// read file
